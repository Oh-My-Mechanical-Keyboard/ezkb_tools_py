...
class PlateGenerator(object):
	...
	#init
	def __init__(self, arg_ct, arg_cr, arg_st, arg_sr, arg_at, arg_ar, arg_uw, arg_uh, arg_key_north, arg_key_rgb, arg_db):
	...
	def render_switch(self, switch):
		...
		self.draw_switch_hole(mm_center_x, mm_center_y, switch.angle + switch.cutout_angle)

		#Draw main RGB hole
		# self.draw_switch_rgb_hole(mm_center_x, mm_center_y, switch.angle + switch.cutout_angle)
...
if __name__ == "__main__":
	...
	args.unit_width, args.unit_height, args.key_north, args.key_rgb, args.debug_log)
